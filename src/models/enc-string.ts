...
export class EncString implements Encrypted {
  ...
  get ivBytes(): Uint8Array {
    return this.iv == null ? new Uint8Array() : Utils.fromB64ToArray(this.iv);
  }

  get macBytes(): Uint8Array {
    return this.mac == null ? new Uint8Array() : Utils.fromB64ToArray(this.mac);
  }

  get dataBytes(): Uint8Array {
    return this.data == null
      ? new Uint8Array()
      : Utils.fromB64ToArray(this.data);
  }
